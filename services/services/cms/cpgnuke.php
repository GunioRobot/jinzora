<?php if (!defined(JZ_SECURE_ACCESS)) die ('Security breach detected.');
	...
	*/
	...
	define('SERVICE_CMS_cpgnuke','true');
	...
	* @since 6/3/05
	**/
	function SERVICE_CMSCLOSE_cpgnuke() {
		CloseTable();
	...
	**/
	function SERVICE_CMSCSS_cpgnuke() {
		global $include_path,$bgcolor1,$bgcolor2,$bgcolor3,$bgcolor4,$thename,$cms_mode,
	...
	* @since 6/3/05
	**/
	function SERVICE_CMSGETVARS_cpgnuke() {
		$a = array();
		$a['name'] = $_GET['name'];
	...
	* @since 6/26/06
	**/
	function SERVICE_CMSDEFAULTDB_cpgnuke() {
		return "cpgnuke";
	}
?>