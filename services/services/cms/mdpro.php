<?php if (!defined(JZ_SECURE_ACCESS)) die ('Security breach detected.');
	...
	*/
	...
	$jzSERVICE_INFO['name'] = "mdpro";
	$jzSERVICE_INFO['url'] = "http://www.mdpro.com";

	define('SERVICE_CMS_mdpro','true');
	...
	* @since 6/3/05
	**/
	function SERVICE_CMSOPEN_mdpro($authenticate_only) {
		...
		"installed as a mdpro module and you're trying to access it outside of mdpro");
		}
	...
	* @since 6/3/05
	**/
	function SERVICE_CMSCLOSE_mdpro() {
		CloseTable();
	...
	* @since 6/3/05
	**/
	function SERVICE_CMSGETVARS_mdpro() {
		$a = array();
		$a['op'] = "modload";
		$a['name'] = $_GET['name'];
		$a['file'] = "index";
	...
	* @since 6/26/06
	**/
	function SERVICE_CMSDEFAULTDB_mdpro() {
		return "mdpro";
	}
?>